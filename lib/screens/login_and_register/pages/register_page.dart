...
import 'package:ramadan_cmpetitions/screens/home_page/pages/layout_page.dart';
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            DropDownCompetitionList(screenWidth: screenWidth,select: SELECT_COMPETITION_NAME,color: HEX_ORANGE_COLOR,),
            SizedBox(
            ...
            BuildButton(
              ...
              text: CREATE_ACCOUNT,
              routeName: LayoutPage.routeName,
            ),
            SizedBox(
