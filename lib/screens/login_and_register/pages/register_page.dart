      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            DropDownCompetitionList(screenWidth: screenWidth,select: SELECT_COMPETITION_NAME,color: HEX_RED_COLOR,),
            SizedBox(
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  width: 100,
                  height: 100,
                  child: Image.file(File(AccountCubit.get(context).imageFile!.path),fit: BoxFit.fill,),
                )
              ],
            ),
            SizedBox(
